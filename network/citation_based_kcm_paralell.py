...
class ParallelKPMGenerator:
    ...
    def __init__(self, debugging = False):
        ...
        self.progress_file = op.join(self.path_manager.kpm_dir, 'progress_citation_based.pkl')
        self.kpm_file = op.join(self.path_manager.kpm_dir, 'df_kpm_citation_based_parallel.csv')
                    ...
                    for future in as_completed(future_to_batch):
                        ...
                        try:
                            ...
                            if results['status'] == 'success':
                                ...
                                if len(progress['completed_batches']) % 10 == 0:
                                    self.save_progress(progress, df_kpm)
    ...
    def save_final_kpm(self, df_kpm):
        ...
        final_kpm_path = op.join(self.path_manager.kpm_dir, "df_kpm_citation_based_final.csv")
...
# nohup python ./network/citation_based_kpm_paralell.py >> citation_based_kpm_paralell.log 2>&1 &

# ps aux | grep citation_based_kpm_paralell.py
# pkill -f citation_based_kpm_paralell.py
